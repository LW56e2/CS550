...
def get_sleep_time(line: str):
    ...
    base_sleep_time = 0.5  # Base time of 0.5 seconds to prevent it from going too fast
...
class ChoiceNode(StoryNode):
    ...
    def __init__(self, coordinates: tuple[int, int], prompt: str, choice_list: list):
        """
        Initialize super class and the list of choices and consequences.
...
class ConditionalNode:
    ...
    def __init__(self, coordinates: tuple[int, int], conditions_list: list):
        """
        Initialize super class and list of conditions and pointers
    ...
    def run(self):
        ...
        for condition_and_pointer in self.conditions_list:  # Iterate through all conditions and pointers in self.conditions_list
            try:
                if eval(condition_and_pointer[0]):  # Evaluate the condition
...
class EffectNode:
    ...
    def __init__(self, coordinates: tuple[int, int], code: str, pointer: tuple[int, int]):
        """
        Initialize super class and direct pointer.
